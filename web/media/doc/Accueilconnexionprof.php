<?php 
 ...
 session_start();
		...
		if ($_SESSION['logged'] != "1")
		{
			...
			$query = "SELECT IdentifiantProf, MtpProf FROM Professeur WHERE IdentifiantProf ='$identifiant' AND MtpProf ='$mtpProf'";
		...
		{
			$nb = "1";
			$identifiant = $_SESSION['IdentifiantProf'];
		}

			if ($nb == "1")
			{
				$_SESSION['IdentifiantProf'] = $identifiant;
				
				
				$_SESSION['logged'] = "1";
				
				$tmp = mysql_query("SELECT * FROM Professeur WHERE IdentifiantProf = '$identifiant' LIMIT 1") or die(mysql_error());
				$prof = mysql_fetch_assoc($tmp);
			}
			else
			{
				...
				header('Location: Connexionprof.php'); 
			}
	...
	<body>
		...
		<table style="background-image: url(images/page-blanche.jpg)" border="0" width="1109px" height="782px"> 
				...
				<?php
							...
							echo "<h2>Bienvenue ".$prof['PrenomProf']." ".$prof['NomProf']."</h2>";
						?>
						<center>
